...
<div class="bg-[#0F172A]">
  <!-- Hero -->
  <div class="flex justify-center py-5 bg-[#1F1C46]">
    <img src="public/logo.svg" />
  </div>
  <div class="bg-slate-900">
    <div class="bg-gradient-to-b from-violet-600/[.15] via-transparent">
      <div class="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
        <!-- Title -->
            ...
            >
              <span class="flex">
                ...
                <span class="grow ml-6">
                  ...
                  <span
                    class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200"
                    >Watch the data roll in as participants vote. LivePoll Pro instantly compiles
                    and displays results, allowing you to interpret and share findings with your
                    audience immediatel</span
                  >
                </span>
              </span>
            </button>
